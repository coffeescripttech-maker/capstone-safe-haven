...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host ""
    Write-Host "📖 See RBAC_TESTING_GUIDE.md for detailed testing instructions" -ForegroundColor Cyan
    Write-Host "📋 See TEST_USERS_QUICK_REFERENCE.md for quick reference" -ForegroundColor Cyan
    Write-Host ""
} else {
    Write-Host ""
