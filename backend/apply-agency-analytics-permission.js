...
async function applyMigration() {
  ...
  try {
    // Read migration file
    const migrationPath = path.join(__dirname, '../database/migrations', '012_add_analytics_permission_agency_roles.sql');
    ...
    console.log('1. Recompile backend: npm run build');
