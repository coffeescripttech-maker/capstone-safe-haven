...
export default function IncidentsListPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-orange-50/10 to-gray-50 p-6">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50 p-8">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-orange-700 rounded-2xl flex items-center justify-center shadow-lg shadow-orange-500/30 animate-pulse-slow">
                <FileText className="w-8 h-8 text-white" strokeWidth={2.5} />
              </div>
              <div>
                <h1 className="text-3xl font-bold bg-gradient-to-r from-gray-900 via-orange-700 to-gray-900 bg-clip-text text-transparent mb-1">
                  Incident Reports
                </h1>
                <p className="text-gray-600 flex items-center gap-2">
                  <TrendingUp className="w-4 h-4 text-orange-500" />
                  View and manage incident reports from the community
                </p>
              </div>
            </div>
            <button
      ...
      {/* Incidents Table with Glass Morphism */}
      <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg overflow-hidden border border-white/50">
        {filteredIncidents.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 text-lg font-bold mb-2">No incidents found</p>
