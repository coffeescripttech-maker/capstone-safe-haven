...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Error toast handled in login function
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">SafeHaven Admin</h1>
          <p className="text-gray-600">Disaster Management System</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
            ...
            <p className="text-xs text-blue-700">Email: admin@safehaven.ph</p>
