# PowerShell Script: Apply Token Blacklist Migration
# Description: Applies the token blacklist table migration
# Usage: .\apply-token-blacklist-migration.ps1

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Token Blacklist Migration Script" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$confirmation = Read-Host "This will create the token_blacklist table. Continue? (yes/no)"
...
# Apply migration
$migration = "005_create_token_blacklist_table.sql"
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "  • token_blacklist table created" -ForegroundColor White
    Write-Host "  • Logout functionality enabled" -ForegroundColor White
} else {
    Write-Host ""
